...
window.cangcilungMantra.SKILLS = {
  ...
  backtest:  { cmd: '/backtest SYM STRAT PARAMS', desc: 'uji strategi (rsi/bb/sma/ema/vwap/ma/smc/cvd/all/adaptive — adaptive default & adaptif per kondisi market) + cost:N biaya/trade + oos anti-overfit', tags: ['backtest', 'strategi', 'uji'] },
  ...
  sinyal:    { cmd: '/sinyal SYM STRAT',          desc: 'pantau live signal BUY/SELL real-time (rsi/bb/sma/ema/vwap/ma/smc/cvd/all/adaptive — default adaptive)', tags: ['signal', 'sinyal', 'livesignal', 'notifikasi sinyal', 'pantau'] },
  ml:        { cmd: '/ml SYM',                     desc: 'latih model Deep Learning/neural network di browser — prediksi arah harga + laporan validasi (anti-overfit) + akurasi OOS', tags: ['machine learning', 'maschine learning', 'deep learning', 'ml', 'neural', 'neuralnet', 'ai', 'model ai', 'kecerdasan buatan'] },
  'ml-signal': { cmd: '/ml-signal SYM STRAT',       desc: 'prediksi arah ML + skor probabilitas sinyal TA (BUY/SELL) saat ini benar', tags: ['ml signal', 'ml-signal', 'mlsignal', 'skor sinyal', 'probabilitas sinyal', 'confidence'] }
};
