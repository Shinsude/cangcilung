...
window.cangcilungMantra.SKILLS = {
  ...
  backtest:  { cmd: '/backtest SYM STRAT PARAMS', desc: 'uji strategi (rsi/macd/bb/sma/all) + cost:N biaya/trade + oos anti-overfit', tags: ['backtest', 'strategi', 'uji'] },
  ...
  sinyal:    { cmd: '/sinyal SYM STRAT',          desc: 'pantau live signal BUY/SELL real-time (rsi/macd/bb/sma/all)', tags: ['signal', 'sinyal', 'livesignal', 'notifikasi sinyal', 'pantau'] }
};
