...
window.cangcilungMantra.SKILLS = {
  ...
  backtest:  { cmd: '/backtest SYM STRAT PARAMS', desc: 'uji strategi (rsi/bb/sma/ema/vwap/ma/smc/cvd/all) + cost:N biaya/trade + oos anti-overfit', tags: ['backtest', 'strategi', 'uji'] },
  ...
  sinyal:    { cmd: '/sinyal SYM STRAT',          desc: 'pantau live signal BUY/SELL real-time (rsi/bb/sma/ema/vwap/ma/smc/cvd/all)', tags: ['signal', 'sinyal', 'livesignal', 'notifikasi sinyal', 'pantau'] }
};
