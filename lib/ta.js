...
(function () {
  ...
  function formatWalkforward(r, symbol) {
    ...
    out += '- Trades: ' + r.closedSignals + ' | Win Rate: ' + r.winRate + '% | PF: ' + r.profitFactor + ' | Net: ' + (r.netProfit >= 0 ? '+' : '') + '$' + r.netProfit + '\n\n';
    out += '### Hasil **Out-of-Sample** (data uji terbaru):\n';
    out += '- Trades OOS: ' + r.oos.trades + ' | **Win Rate OOS:** ' + r.oos.winRate + '% | **PF OOS:** ' + r.oos.profitFactor + ' | **Net OOS:** ' + (r.oos.netProfit >= 0 ? '+' : '') + '$' + r.oos.netProfit + '\n';
